...
<%@page import="com.WishListItem"%>
<%@page import="com.WishListItemDAO"%>
...
<html>
    <head>
        ...
        <title>ShopSmart-WishList</title>
    ...
    <body>
        ...
        <%            WishListItemDAO wishListItemDAO = new WishListItemDAO(FactoryProvider.getFactory());
            List<WishListItem> wishListItems = wishListItemDAO.getWishListItemByUserId(user.getUserId());
                    ...
                    <div class="col-md-8">
                        <div class="card mb-4">
                            <div class="card-header py-3">
                                <h5 class="mb-0">Cart - <%=wishListItems.size()%> Items</h5>
                            </div>

                            <div class="card-body">
                                <!-- Single item -->
                                <%
                                    for (WishListItem c : wishListItems) {

                                        Product p = c.getWishListItemProduct();
...
<!--                                            <input class="mb-2 " type="text" value=
                                                   <%= //c.getQuantity()%> 
                                                   style="width: 30px; margin-right: 10px" readonly>-->
