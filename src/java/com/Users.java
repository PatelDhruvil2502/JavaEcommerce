...
public class Users {
    ...
    @OneToMany(mappedBy = "cartItemUser")
    private Set<CartItem> cartItem;
    
    @OneToMany(mappedBy = "wishListItemuser")
    ...
    public Users(int userId, String userName, String userEmail, String userPassword, String userPhone, String userPic, String userAddress, String userType) {
        this.userId = userId;
        this.userName = userName;
        this.userEmail = userEmail;
        this.userPassword = userPassword;
